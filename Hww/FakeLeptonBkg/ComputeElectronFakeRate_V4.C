//root -l EWKAna/Hww/FakeRate/ComputeElectronFakeRate_V4.C+\(\)
//================================================================================================
//
// HWW selection macro
//
...
//=== MAIN MACRO =================================================================================================
void ComputeElectronFakeRate_V4() {


//   DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/cern/filefi/015/old/FakeRate_egcombined.root","ElectronFakeRate_elecombined_v3_Ele10Jet30","ElectronFakeRate_V4.root",2);
...
//   DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/cern/filefi/015/old/FakeRate_egcombined.root","ElectronFakeRate_elecombined_v5_Ele10Jet30","ElectronFakeRate_V4.root",2);
//   DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/cern/filefi/015/old/FakeRate_egcombined.root","ElectronFakeRate_elecombined_v6_Ele10Jet30","ElectronFakeRate_V4.root",2);


  DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/WWAnalysisSkimmed_jet-d22_fakeskim.root","ElectronFakeRate_jetcombined_v3_Jet30","ElectronFakeRate_V4.root",102);
//    DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/WWAnalysisSkimmed_jet-d22_fakeskim.root","ElectronFakeRate_jetcombined_v4_Jet30","ElectronFakeRate_V4.root",102);
//     DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/WWAnalysisSkimmed_jet-d22_fakeskim.root","ElectronFakeRate_jetcombined_v5_Jet30","ElectronFakeRate_V4.root",102);   // reliso < 0.4
 //     DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/WWAnalysisSkimmed_jet-d22_fakeskim.root","ElectronFakeRate_jetcombined_v6_Jet30","ElectronFakeRate_V4.root",102); //+  rel iso < 1.0
//      DoComputeElectronFakeRate("/home/sixie/hist/FakeRate/WWAnalysisSkimmed_jet-d22_fakeskim.root","ElectronFakeRate_jetcombined_v7_Jet30","ElectronFakeRate_V4.root",102); //  no iso cut
...
//    hasJSON = kFALSE;
  ...
  for(UInt_t ientry=0; ientry<eventTree->GetEntries(); ientry++) {       	
    ...
    //low lumi scenario
//     if (info->runNum > 143962) continue;
//     //high lumi scenario
//     if (info->runNum < 143962) continue;
 ...
 //      if (ele->pt > 20) continue;
      ...
      if (passElectronNumeratorCuts(ele)) {
...
Bool_t passElectronNMinusOneCuts (const mithep::TElectron *ele, Int_t varIndex) {
  ...
  if (TMath::Abs(ele->eta) < 1.479) {
    ...
    if (varIndex != 4 && !((ele->trkIso03 + TMath::Max(ele->emIso03 - 1.0, 0.0) + ele->hadIso03) / ele->pt < 0.1)) result = kFALSE;
  } else {
    ...
    if (varIndex != 4 && !((ele->trkIso03 + ele->emIso03  + ele->hadIso03) / ele->pt < 0.1)) result = kFALSE;
  }
...
Bool_t passElectronDenominatorCuts(const mithep::TElectron *ele, Int_t SelectionType) {
  ...
  //relative isolation
  Double_t combIso = ele->trkIso03 +  TMath::Max(ele->emIso03 - 1.0 , 0.0) + ele->hadIso03;
  if (fabs(ele->eta) > 1.479) {
    combIso = ele->trkIso03 +  ele->emIso03  + ele->hadIso03;
  }
//   if (!(combIso / ele->pt < 0.3)) pass = kFALSE;
