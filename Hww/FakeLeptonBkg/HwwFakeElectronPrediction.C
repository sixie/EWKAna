...
//root -l EWKAna/Hww/FakeLeptonBkg/HwwFakeElectronPrediction.C+\(\"/home/sixie/hist/HwwAnalysis/2011Data/WWAnalysisSkimmed_r11a-full-pr_LooseLooseTriggerSkim.root\",130,\"\"\)


//root -l EWKAna/Hww/FakeLeptonBkg/HwwFakeElectronPrediction.C+\(\"/home/sixie/hist/HwwAnalysis/2011Data/WWAnalysisSkimmed_r11a-full-pr_TightPlusRecoTriggerSkim.root\",130,\"\"\)
//root -l EWKAna/Hww/FakeRate/HwwFakeElectronPrediction.C+\(\"WWAnalysisSkimmed_r10b-mu-d22_TwoRecoLeptonNoTriggerSkim.root\",130,\"\"\)
//root -l EWKAna/Hww/FakeRate/HwwFakeElectronPrediction.C+\(\"WWAnalysisSkimmed_full-d22_TwoRecoLeptonWithTriggerPlusOneTightLeptonSkim.root\",130,\"\"\)
//================================================================================================
//
// HWW selection macro
//
...
void HwwFakeElectronPrediction(const string inputFilename, Double_t mHiggs, 
                 const string Label) 
{  
...
//                                                              "ElectronFakeRate.SmurfV6-EleLikelihood13.skim.root",
//                                                            "ElectronFakeRate.SmurfV6-EleLikelihood24.skim.root",
...
//    hasJSON = kFALSE;
  ...
  for(UInt_t ientry=0; ientry<eventTree->GetEntries(); ientry++) {       	
    ...
    if ( (0 == 1) 
         || (info->runNum == 160957 && info->evtNum == 459919420)
         || (info->runNum == 163374 && info->evtNum == 97076265)
         || (info->runNum == 163657 && info->evtNum == 81185020)
         || (info->runNum == 163738 && info->evtNum == 206166882)  

         || (info->runNum == 163069 && info->evtNum == 123141439)
         || (info->runNum == 163869 && info->evtNum == 67318151)
         || (info->runNum == 163869 && info->evtNum == 82912284)
...
//        if (passNewElectronCuts(ele, likelihoodValue, 13)) continue;
...
//              && finalState == 0
            ...
            eventListFile << info->runNum << " " << info->lumiSec << " " << info->evtNum << " : " << ele->pt << " " << ele->eta << " : " << fakeRate  << endl;
          }
          ...
          Double_t ptCategory = ele->pt;
          Double_t etaCategory = ele->eta;
...
//   TFile *file = new TFile("WWSelectionPlots_IsoDenominator.root", "RECREATE");
  ...
  file = new TFile("ElectronFakeRate.SmurfV5.skim.root", "UPDATE");
