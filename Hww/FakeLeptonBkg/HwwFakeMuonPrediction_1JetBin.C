//root -l EWKAna/Hww/FakeLeptonBkg/HwwFakeMuonPrediction_1JetBin.C+\(\"/home/sixie/hist/HwwAnalysis/2011Data/WWAnalysisSkimmed_r11a-full-pr_TightPlusRecoTriggerSkim.root\",130,\"\"\)
//================================================================================================
//
// HWW selection macro
//
...
void HwwFakeMuonPrediction_1JetBin(const string inputFilename, Double_t mHiggs, 
                 const string Label) 
{  
...
//   ChargeSelection = 1;
 ...
 //                                                         "MuonFakeRateDenominatorM1_Mu8Sample_ptThreshold15_PtEta",
...
//       if (dz > zDiffMax) zDiffMax = dz;
      ...
      if (leptonPt[0] > mu->pt) {
        ...
        lepton2.SetCoordinates(mu->pt, mu->eta, mu->phi, 0.51099892e-3 );
      } else {
        if (leptonType[0] == 13) {
          finalState = 1;
        ...
        lepton1.SetCoordinates(mu->pt, mu->eta, mu->phi, 0.51099892e-3 );
      }
