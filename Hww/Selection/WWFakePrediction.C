//root -l EWKAna/Hww/Selection/WWFakePrediction.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysis_r10a-eg-s17_noskim.root\",\"\"\)
//root -l EWKAna/Hww/Selection/WWFakePrediction.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysis_r10b-el-pr-v2_noskim.root\",\"\"\)
//root -l EWKAna/Hww/Selection/WWFakePrediction.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysis_r10b-mu-pr-v2_noskim.root\",\"\"\)
//root -l EWKAna/Hww/Selection/WWFakePrediction.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysis_r10a-mu-s17_noskim.root\",\"\"\)
//root -l EWKAna/Hww/Selection/WWFakePrediction.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysisSkimmed_full_noskim.root\",\"\"\)
//root -l EWKAna/Hww/Selection/WWFakePrediction.C+\(\"/home/sixie/hist/HwwAnalysis/WWAnalysisSkimmed_full-d22_noskim.root\",\"\"\)
//================================================================================================
//
// HWW selection macro
//
...
void WWFakePrediction(const string inputFilename, 
                 const string Label) 
{  
...
//   ChargeSelection = 1;
  ...
  mithep::FakeRate *fFakeRate = new mithep::FakeRate("ElectronFakeRate_V4.root",
                                                     ...
                                                     "", "",
//                                                       "ElectronFakeRate_EG_v4_Ele10Jet30_PtEta",
...
//                            use2DFakeRate, useFitFunction );
  ...
  TH1D *fHWWSelection_sysError= new TH1D("hHWWSelection_sysError", ";Cut Number;Number of Events", 11, -1.5, 9.5); 
  TH1D *fHWWToEESelection_sysError= new TH1D("hHWWToEESelection_sysError", ";Cut Number;Number of Events", 11, -1.5, 9.5);
  TH1D *fHWWToMuMuSelection_sysError= new TH1D("hHWWToMuMuSelection_sysError", ";Cut Number;Number of Events", 11, -1.5, 9.5);
  TH1D *fHWWToEMuSelection_sysError= new TH1D("hHWWToEMuSelection_sysError", ";Cut Number;Number of Events", 11, -1.5, 9.5);
      ...
      fHWWSelection_sysError->Fill(-1, eventWeightError);
        ...
        if (passAllCuts) {
          ...
          eventDump(eventListFile, info->runNum, info->lumiSec, info->evtNum, dilepton.M(),
                    lepton1.Pt(), lepton1.Eta(), lepton1.Phi(), leptonCharge[i], lepton2.Pt(), lepton2.Eta(), lepton2.Phi(), ele->q);
...
//   }
  ...
  cout << "BB :" << Count_ee << " +/- " << Count_ee_statError << " +/- " << Count_ee_sysError <<  endl;
  cout << "**************************************************************\n";
  cout << "Event Count : mm final state\n";
  cout << "BB :" << Count_mm << " +/- " << Count_mm_statError << " +/- " << Count_mm_sysError << endl;
  cout << "**************************************************************\n";
  cout << "Event Count : em final state\n";
  cout << "BB :" << Count_em << " +/- " << Count_em_statError << " +/- " << Count_em_sysError<< endl;
