//root -l EWKAna/Hww/Selection/SkimNtuples.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysis_mu_noskim.root\",\"WWAnalysisSkimmed_mu_noskim.root\",kTRUE,kFALSE\)
//root -l EWKAna/Hww/Selection/SkimNtuples.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysis_ele_noskim.root\",\"WWAnalysisSkimmed_ele_noskim.root\",kFALSE,kFALSE\)
...
// Main macro function
//--------------------------------------------------------------------------------------------------
void SkimNtuples(string inputFilename, string outputFilename, Bool_t isMuonData, Bool_t isMC) 
{
...
//     if (!(NMuons+NElectrons >= 1 && NRecoLeptons >= 2)) {
//       keep = kFALSE;
//     }
