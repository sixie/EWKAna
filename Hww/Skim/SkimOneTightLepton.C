//root -l EWKAna/Hww/Skim/SkimTrigger.C+\(\"WWAnalysisSkimmed_full-d22_TwoRecoLeptonWithTriggerSkim.root\",\"WWAnalysisSkimmed_full-d22_TwoRecoLeptonWithTriggerPlusOneTightLeptonSkim.root\",kTRUE,kFALSE\)
//root -l EWKAna/Hww/Skim/SkimTrigger.C+\(\"/home/sixie/hist/WWAnalysis/WWAnalysis_ele_noskim.root\",\"WWAnalysisSkimmed_ele_noskim.root\",kFALSE,kFALSE\)
...
// Main macro function
//--------------------------------------------------------------------------------------------------
void SkimOneTightLepton(string inputFilename, string outputFilename, Bool_t isMuonData, Bool_t isMC) 
{
