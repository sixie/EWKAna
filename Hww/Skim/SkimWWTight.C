//root -l EWKAna/Hww/Skim/SkimWWTight.C+\(\"/home/sixie/hist/FakeRate/FakeRate_r10a-eg-d22_noskim.root\",\"FakeRate_r10a-eg-d22_wwskim.root\",kTRUE,kFALSE\)
...
// Main macro function
//--------------------------------------------------------------------------------------------------
void SkimWWTight(string inputFilename, string outputFilename, Bool_t isMuonData, Bool_t isMC) 
{
