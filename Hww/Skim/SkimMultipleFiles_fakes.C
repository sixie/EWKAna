//root -l EWKAna/Hww/Skim/SkimMultipleFiles_fakes.C+\(\"EWKAna/Hww/Skim/SkimInput_fakes_r10a-mu-d22.txt\",\"WWAnalysisSkimmed_r10a-mu-d22_fakeskim.root\"\)
//root -l EWKAna/Hww/Skim/SkimMultipleFiles_fakes.C+\(\"EWKAna/Hww/Skim/SkimInput_fakes_r10b-mu-d22.txt\",\"WWAnalysisSkimmed_r10b-mu-d22_fakeskim.root\"\)
//root -l EWKAna/Hww/Skim/SkimMultipleFiles_fakes.C+\(\"EWKAna/Hww/Skim/SkimInput_jet-d22.txt\",\"WWAnalysisSkimmed_jet-d22_fakeskim.root\"\)
//root -l EWKAna/Hww/Skim/SkimMultipleFiles_fakes.C+\(\"EWKAna/Hww/Skim/SkimInput_p11-qcd30_50-v1g1-pu.txt\",\"WWAnalysisSkimmed_p11-qcd30_50-v1g1-pu-skimmed_RecoLeptonPlusJetSkim.root\"\) |& tee logSkim_p11-qcd30_50-v1g1-pu
//root -l EWKAna/Hww/Skim/SkimMultipleFiles_fakes.C+\(\"EWKAna/Hww/Skim/SkimInput_p11-qcd15_30-v1g1-pu.txt\",\"WWAnalysisSkimmed_p11-qcd15_30-v1g1-pu-skimmed_RecoLeptonPlusJetSkim.root\"\) |& tee logSkim_p11-qcd15_30-v1g1-pu
//root -l EWKAna/Hww/Skim/SkimMultipleFiles_fakes.C+\(\"EWKAna/Hww/Skim/SkimInput_p11-qcd15_3000-v1g1-pu.txt\",\"WWAnalysisSkimmed_p11-qcd15_3000-v1g1-pu-skimmed_RecoLeptonPlusJetSkim.root\"\) |& tee logSkim_p11-qcd15_3000-v1g1-pu
...
Bool_t passElectronCuts(const mithep::TElectron *ele) {
  ...
  if (fabs(ele->eta) < 1.5) {
    if (! ( (0==0)
            ...
            && ele->HoverE < 0.04
            && (ele->trkIso03 + TMath::Max(ele->emIso03 - 1.0, 0.0) + ele->hadIso03) / ele->pt < 0.10
            && ele->nExpHitsInner <= 0
