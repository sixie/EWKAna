...
void selectMuonBDTGV3PFIsoEffTP(const TString conf,     // input file
  ...
  //Setup MVA
  //*****************************************************************************************
  mithep::MuonIDMVA *muonIDMVAWithIPInfo = new mithep::MuonIDMVA();
  muonIDMVAWithIPInfo->Initialize("BDTG method",
                              "/home/sixie/CMSSW_analysis/src/MitPhysics/data/MuonMVAWeights/BarrelPtBin0_V3_BDTG.weights.xml", 
                              "/home/sixie/CMSSW_analysis/src/MitPhysics/data/MuonMVAWeights/EndcapPtBin0_V3_BDTG.weights.xml", 
                              "/home/sixie/CMSSW_analysis/src/MitPhysics/data/MuonMVAWeights/BarrelPtBin1_V3_BDTG.weights.xml", 
                              "/home/sixie/CMSSW_analysis/src/MitPhysics/data/MuonMVAWeights/EndcapPtBin1_V3_BDTG.weights.xml", 
                              "/home/sixie/CMSSW_analysis/src/MitPhysics/data/MuonMVAWeights/BarrelPtBin2_V3_BDTG.weights.xml", 
                              "/home/sixie/CMSSW_analysis/src/MitPhysics/data/MuonMVAWeights/EndcapPtBin2_V3_BDTG.weights.xml",
                              mithep::MuonIDMVA::kV3);
  ...
  for(UInt_t ifile=0; ifile<fnamev.size(); ifile++) {  
	...
	if(!passMuonMVAV3(tag, muonIDMVAWithIPInfo->MVAValue(
                            tag->pt, tag->eta,
                            tag->tkNchi2,
                            tag->muNchi2,
                            tag->nValidHits,
                            ...
                            tag->HadEnergy/tag->pt,
                            tag->HoEnergy/tag->pt,
                            tag->EmEnergy/tag->pt,
                            tag->HadS9Energy/tag->pt,
                            tag->HoS9Energy/tag->pt,
                            tag->EmS9Energy/tag->pt
                            ) 
             ))     continue;
	...
	for(Int_t j=0; j<muonArr->GetEntriesFast(); j++) {
	  ...
	  Bool_t pass = passMuonMVAV3(probe,muonIDMVAWithIPInfo->MVAValue(
                                        probe->pt, probe->eta,
                                        probe->tkNchi2,
                                        probe->muNchi2,
                                        probe->nValidHits,
                                        ...
                                        probe->HadEnergy/probe->pt,
                                        probe->HoEnergy/probe->pt,
                                        probe->EmEnergy/probe->pt,
                                        probe->HadS9Energy/probe->pt,
                                        probe->HoS9Energy/probe->pt,
                                        probe->EmS9Energy/probe->pt ) );
