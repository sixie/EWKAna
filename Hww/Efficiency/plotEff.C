...
#include "Common/CEffUser1D.hh"     // class for handling efficiency graphs
#include "Common/CEffUser2D.hh"     // class for handling efficiency tables
...
//
  ...
  RooRealVar Nsig("Nsig","Signal Yield",0.946*NsigMax,0,NsigMax);
  RooRealVar eff("eff","Efficiency",0.946,0,1.0);
