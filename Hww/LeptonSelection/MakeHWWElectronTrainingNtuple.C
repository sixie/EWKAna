...
//=== MAIN MACRO =================================================================================================
void MakeHWWElectronTrainingNtuple() {

  MakeNtuple("/data/blue/sixie/ntuples/HWW/mc/HwwAnalysis_s11-h115ww2l-gf-v11-pu_noskim_normalized.root","ElectronSelectionTraining.HWW115.root");
  MakeNtuple("/data/blue/sixie/ntuples/HWW/mc/HwwAnalysis_s11-h120ww2l-gf-v11-pu_noskim_normalized.root","ElectronSelectionTraining.HWW120.root");
  MakeNtuple("/data/blue/sixie/ntuples/HWW/mc/HwwAnalysis_s11-h130ww2l-gf-v11-pu_noskim_normalized.root","ElectronSelectionTraining.HWW130.root");
  ...
  for (UInt_t f = 0; f < inputfiles.size(); ++f) {
    ...
    for(UInt_t ientry=0; ientry < eventTree->GetEntries(); ientry++) {       	
      ...
      for(Int_t i=0; i<electronArr->GetEntries(); i++) {
        ...
        if (!passElectronDenominatorCuts(ele, 4)) continue;
       ...
       //Fill These Electrons
        ...
        fEleNeutralHadronIso04 = ele->NeutralHadronIso04_01Threshold; 
        fEleGammaIso04 = ele->GammaIso04_01Threshold; 
