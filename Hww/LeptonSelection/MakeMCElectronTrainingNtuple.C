...
void MakeNtuple(const string inputFilename,  const string outputFilename, const string PUReweightFile, Bool_t SelectRealElectrons);
...
//=== MAIN MACRO =================================================================================================
void MakeMCElectronTrainingNtuple() {

  //HWW 
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-h115ww2l-gf-v11-pu_noskim_0000.root","ElectronSelectionTraining.HWW115.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE);
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-h120ww2l-gf-v11-pu_noskim_0000.root","ElectronSelectionTraining.HWW120.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE);
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-h130ww2l-gf-v11-pu_noskim_0000.root","ElectronSelectionTraining.HWW130.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE);

  //Z->ee
  MakeNtuple("Fall11Zee","ElectronSelectionTraining.Fall11Zee.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE);

  //W+Jets
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_w10-wjets-z2-v8-pu11-2l_noskim.root","ElectronSelectionTraining.WJets_Winter10Skimmed.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kFALSE);
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-wjets-v11-pu_noskim.root","ElectronSelectionTraining.WJets_Summer11Skimmed.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kFALSE);
...
{  
  ...
  rlrm.AddJSONFile("/data/smurf/data/LP2011/auxiliar/HWW.conservativeCertificationLP11.json"); 
  ...
  } else if (inputFilename == "Fall11Zee") {
    inputfiles.push_back("/home/sixie/hist/AllNtuple/HWWNtuple/mc025/AllNtuple_HWWNtuple_f11-zeem20-powheg-v14b-pu_noskim_0000.root");
    inputfiles.push_back("/home/sixie/hist/AllNtuple/HWWNtuple/mc025/AllNtuple_HWWNtuple_f11-zeem20-powheg-v14b-pu_noskim_0002.root");
    inputfiles.push_back("/home/sixie/hist/AllNtuple/HWWNtuple/mc025/AllNtuple_HWWNtuple_f11-zeem20-powheg-v14b-pu_noskim_0003.root");
    inputfiles.push_back("/home/sixie/hist/AllNtuple/HWWNtuple/mc025/AllNtuple_HWWNtuple_f11-zeem20-powheg-v14b-pu_noskim_0005.root");
    inputfiles.push_back("/home/sixie/hist/AllNtuple/HWWNtuple/mc025/AllNtuple_HWWNtuple_f11-zeem20-powheg-v14b-pu_noskim_0006.root");
    inputfiles.push_back("/home/sixie/hist/AllNtuple/HWWNtuple/mc025/AllNtuple_HWWNtuple_f11-zeem20-powheg-v14b-pu_noskim_0007.root");
  } else {
