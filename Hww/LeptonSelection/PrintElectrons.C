...
void PrintEle(const string inputFilename );
...
void PrintElectrons() {
  ...
  PrintEle("/home/sixie/hist/HwwAnalysis/normalized/HwwAnalysis_p11-h130ww2l-gf-v1g1-pu_noskim_normalized.root");
...
//    hasJSON = kFALSE;
  ...
  ofstream outfile("eleIsoSync.txt");
  ...
  for(UInt_t ientry=0; ientry<eventTree->GetEntries(); ientry++) {       	
    ...
    for(Int_t i=0; i<electronArr->GetEntries(); i++) {
      ...
      Double_t pfIso = ele->ChargedIso04 + ele->NeutralHadronIso04_10Threshold
      ...
      outfile << info->evtNum << " " << ele->pt << " " << ele->eta << " " << ele->phi << " " << pfIso/ele->pt << endl;
