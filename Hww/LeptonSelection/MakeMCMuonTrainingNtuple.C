...
void MakeNtuple(const string inputFilename,  const string outputFilename, const string PUReweightFile, Bool_t SelectRealMuons);
...
//=== MAIN MACRO =================================================================================================
void MakeMCMuonTrainingNtuple() {

  //HWW 
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-h115ww2l-gf-v11-pu_noskim_0000.root","MuonSelectionTraining.HWW115.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE);
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-h120ww2l-gf-v11-pu_noskim_0000.root","MuonSelectionTraining.HWW120.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE);
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-h130ww2l-gf-v11-pu_noskim_0000.root","MuonSelectionTraining.HWW130.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kTRUE);

  //Z->mumu
  MakeNtuple("Fall11Zmm","MuonSelectionTraining.Fall11Zmm.root", "/data/smurf/sixie/Pileup/weights/PileupReweighting.Fall11_To_Full2011.root", kTRUE);

  //W+Jets
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_w10-wjets-z2-v8-pu11-2l_noskim.root","MuonSelectionTraining.WJets_Winter10Skimmed.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kFALSE);
  MakeNtuple("/home/sixie/hist/AllNtuple/HWWNtuple/mc/AllNtuple_HWWNtuple_s11-wjets-v11-pu_noskim.root","MuonSelectionTraining.WJets_Summer11Skimmed.root", "/data/smurf/data/Winter11_4700ipb/auxiliar/PileupReweighting.Summer11DYmm_To_Full2011.root", kFALSE);
  ...
  for (UInt_t f = 0; f < inputfiles.size(); ++f) {
    ...
    for(UInt_t ientry=0; ientry < eventTree->GetEntries(); ientry++) {       	
      ...
      for(Int_t i=0; i<muonArr->GetEntries(); i++) {
        ...
        if (!passMuonDenominatorCuts(mu, info->PileupEnergyDensity)) continue;
