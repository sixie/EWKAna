//root -l EWKAna/Hww/FakeRate/HwwDoubleFakePrediction.C+\(\"/home/sixie/hist/HwwAnalysis/WWAnalysisSkimmed_full-d22_noskim.root\",130,\"\"\)
...
//   ChargeSelection = 1;
  ...
  mithep::FakeRate *fFakeRate = new mithep::FakeRate("ElectronFakeRate_V4.root",
                                                     ...
                                                     "", "",
                                                     "ElectronFakeRate_jetcombined_v3_Jet30_PtEta",
...
//           passAllCuts 
          ...
          cout << "Fake rate: " << fakeRate1 << " * " << fakeRate2 << " = " << eventWeight << endl;
