...
assert(jetBin >= 0 && jetBin <= 1);
  ...
  Double_t WWBkgScaleFactorHiggsSelection[2][9] = { 
    { 1.15747,1.15747,1.15748,1.16797,1.15035,1.15352,1.15498,1.14585,1.14468},
    { 1.19947,1.19947,1.19945,1.23281,1.24654,1.24724,1.25774,1.24823,1.24844} };
  Int_t massIndex = -1;
...
assert(jetBin >= 0 && jetBin <= 1);
  ...
  Double_t WWBkgScaleFactorHiggsSelection[2][9] = { 
    ...
    { 1.19947,1.19947,1.19947,1.19947,1.19947,1.19947,1.19947,1.13291,1.13526} };
  Int_t massIndex = -1;
  for (UInt_t m=0; m < 9 ; ++m) {
    if (mH == mHiggs[m]) massIndex = m;
  }
...
assert(jetBin >= 0 && jetBin <= 1);
  ...
  Double_t WWBkgScaleFactorKappaHiggsSelection[2][9] = { 
    ...
    { 1.13365,1.13365,1.13366,1.12908,1.13254,1.13251,1.13141,1.13236,1.13264} };
  Int_t massIndex = -1;
  for (UInt_t m=0; m < 9 ; ++m) {
    if (mH == mHiggs[m]) massIndex = m;
  }
...
assert(jetBin >= 0 && jetBin <= 1);
  ...
  Double_t WWBkgScaleFactorKappaHiggsSelection[2][9] = { 
    ...
    { 1.13365,1.13365,1.13365,1.13365,1.13365,1.13365,1.13365,1.14454,1.15185} };
  Int_t massIndex = -1;
  for (UInt_t m=0; m < 9 ; ++m) {
    if (mH == mHiggs[m]) massIndex = m;
  }
