...
void PlotShapeSystematics() {
  ...
  TFile *file = new TFile("/build/sixie/Thesis/cards/MVAIDIsoCombined2011/130/hww130_sf_0j.input.root","READ");

  TH1F *DefaultShape = (TH1F*)file->Get("histo_Zjets");
  TH1F *UpShape = (TH1F*)file->Get("histo_Zjets_CMS_MVAZBounding_hwwsf_0jUp");
  TH1F *DownShape = (TH1F*)file->Get("histo_Zjets_CMS_MVAZBounding_hwwsf_0jDown");
  ...
  DefaultShape->GetYaxis()->SetRangeUser(0.0,0.5);
  ...
  cv->SaveAs("DYBkgShapeVariation_0Jet.png");
  cv->SaveAs("DYBkgShapeVariation_0Jet.eps");
  ...
  DefaultShape = (TH1F*)file->Get("histo_Zjets");
  UpShape = (TH1F*)file->Get("histo_Zjets_CMS_MVAZBounding_hwwsf_1jUp");
  DownShape = (TH1F*)file->Get("histo_Zjets_CMS_MVAZBounding_hwwsf_1jDown");
  ...
  cv->SaveAs("DYBkgShapeVariation_1Jet.png");
  cv->SaveAs("DYBkgShapeVariation_1Jet.eps");
