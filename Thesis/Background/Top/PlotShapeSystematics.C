...
void PlotShapeSystematics() {
  ...
  file = new TFile("/build/sixie/Thesis/cards/130/hwwof_0j.input.root","READ");

  DefaultShape = (TH1F*)file->Get("histo_Top");
  UpShape = (TH1F*)file->Get("histo_Top_CMS_MVATopBounding_hwwUp");
  DownShape = (TH1F*)file->Get("histo_Top_CMS_MVATopBounding_hwwDown");
  ...
  cv->SaveAs("TopBkgShapeVariation_OF0Jet.png");
  cv->SaveAs("TopBkgShapeVariation_OF0Jet.eps");
  ...
  file = new TFile("/build/sixie/Thesis/cards/130/hwwof_1j.input.root","READ");
  ...
  cv->SaveAs("TopBkgShapeVariation_OF1Jet.png");
  cv->SaveAs("TopBkgShapeVariation_OF1Jet.eps");
  ...
  file = new TFile("/build/sixie/Thesis/cards/130/hwwsf_0j.input.root","READ");
  ...
  cv->SaveAs("TopBkgShapeVariation_SF0Jet.png");
  cv->SaveAs("TopBkgShapeVariation_SF0Jet.eps");
  ...
  file = new TFile("/build/sixie/Thesis/cards/130/hwwsf_1j.input.root","READ");
  ...
  cv->SaveAs("TopBkgShapeVariation_SF1Jet.png");
  cv->SaveAs("TopBkgShapeVariation_SF1Jet.eps");
