...
//
//***************************************************************************
// foreach f ( /home/sixie/hist/AllNtuple/cern/filefi/022/HWWNtuple/data/AllNtuple_HWWNtuple_r11a-dmu-pr-v4_noskim_????.root )
//   root -l -b -q EWKAna/HZZ4l/Skim/SkimFourRecoLeptonsPerFile.C+\(\"${f}\",\"${f}.FourRecoLeptonSkim.root\"\)
// end
...
//
//***************************************************************************
//root -l -b -q EWKAna/HZZ4l/Skim/SkimFourRecoLeptonsPerFile.C+\(\"/home/sixie/hist/AllNtuple/cern/filefi/022/HWWNtuple/AllNtuple_HWWNtuple_r11a-dmu-pr-v4_noskim_0000.root\",\"/home/sixie/hist/AllNtuple/cern/filefi/022/HWWNtuple/AllNtuple_HWWNtuple_r11a-dmu-pr-v4_noskim_0000.root.FourRecoLeptonSkim.root\"\)
...
// Main macro function
//--------------------------------------------------------------------------------------------------
void SkimFourRecoLeptonsPerFile(string inputFilename, string outputFilename) 
{
