...
def NormalizeNtuples( datasetNameList, skimNameList, inputPath, outputPath, filenameHeader):
    ...
    for dataset in datasetNameList:
        ...
        outputFilename = outputPath + 'HZZ4lAnalysis_' + dataset + '_' + skimNameList[n] + '_normalized' + '.root'        
        command = setupcmsswcommand + 'root -l -b -q $CMSSW_BASE/src/EWKAna/HZZ4l/scripts/NormalizeNtuple.C+\(\\\"' + inputFilename + '\\\",\\\"' + dataset + '\\\",\\\"' + outputFilename + '\\\"\\)'
