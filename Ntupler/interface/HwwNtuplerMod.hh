...
namespace mithep
{
  ...
  {    
    public:
      ...
      void SetSCEtMin(Double_t pt)       { fSCEtMin = pt; }
      void SetSCEtMax(Double_t pt)       { fSCEtMax = pt; }
      void SetSCEtaMin(Double_t eta)     { fSCEtaMin = eta; }
      void SetSCEtaMax(Double_t eta)     { fSCEtaMax = eta; }
...
//               << secondObjectModuleName << " " << secondObjectId << endl;
    ...
    protected:
     ...
     // Match electron to HLT primitive
      ...
      TString                 fCaloTowerName;   // calorimeter towers collection name
      ...
      const CaloTowerCol     *fCaloTowers;      // calorimeter towers collection handle
      ...
      Double_t                fSCEtMax;         // maximum supercluster ET
      Double_t                fSCEtaMin;        // minimum supercluster eta
      Double_t                fSCEtaMax;        // maximum supercluster eta
